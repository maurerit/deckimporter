...
import net.maurerit.mtg.deck.impl.MagicOnlineDeckImporter;
...
public class MagicOnlineDeckImporterTest
{
	...
	public void shouldImportBejatosDeck ( ) throws SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, MalformedURLException {
		...
		assertTrue("Should have '21 Mountain'", actual.contains(DeckImporterTestUtils.lookupAndFormatCard(21, "Mountain")));
	...
	public void shouldImportSlivernewsDeck ( ) throws SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, MalformedURLException {
		...
		assertTrue("Should have '1 Plains'", actual.contains(DeckImporterTestUtils.lookupAndFormatCard(1, "Plains")));
		assertTrue("Should have '9 Island'", actual.contains(DeckImporterTestUtils.lookupAndFormatCard(9, "Island")));
		...
		assertTrue("Should have '4 Glacial Fortress'", actual.contains(DeckImporterTestUtils.lookupAndFormatCard(4, "Glacial Fortress")));
		...
		assertTrue("Should have '4 Mana Leak'", actual.contains(DeckImporterTestUtils.lookupAndFormatCard(4, "Mana Leak")));
		...
		assertTrue("Should have 'SB: 2 Oblivion Ring'", actual.contains(DeckImporterTestUtils.lookupAndFormatCardSb(2, "Oblivion Ring")));
		assertTrue("Should have 'SB: 2 Celestial Purge'", actual.contains(DeckImporterTestUtils.lookupAndFormatCardSb(2, "Celestial Purge")));
		assertTrue("Should have 'SB: 3 [M12:40] Timely Reinforcements'", actual.contains("SB: 3 [M12:40] Timely Reinforcements"));
		assertTrue("Should have 'SB: 1 Negate'", actual.contains(DeckImporterTestUtils.lookupAndFormatCardSb(1, "Negate")));
